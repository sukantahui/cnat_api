...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::middleware('role:Admin,Developer,Owner,Manager,Teacher')->group(function () {
        ...
        Route::controller(StudentController::class)->prefix('students')->group(function () {
            ...
            /** GET  /api/students/{student}/previous-admissions → previousAdmissions() All previous course admissions & per-course fee payment ledger */
            Route::get('/{student}/previous-admissions', 'previousAdmissions');
        });
         ...
         */
        Route::get('admissions/dues', [AdmissionController::class, 'dues']);
...
if (app()->environment('local')) {
    Route::group(['prefix' => 'dev'], function () {
        ...
        Route::controller(StudentController::class)->prefix('students')->group(function () {
            Route::get('/', 'index');
            Route::post('/', 'store');
            Route::get('/{studentId}/previous-admissions', 'previousAdmissions');
